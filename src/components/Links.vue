...
const linkList = ref<any[]>([{href:`https://www.linkedin.com/in/konstantinos-stylianou-a4a95625b/` ,icon:`line-md:linkedin` },{href:`https://github.com/AliBaBas02` ,icon:`line-md:github-loop` },{href:`https://twitter.com/AliBaBaSssS` ,icon:`line-md:twitter-x` },{href:`https://www.instagram.com/_kostas_styl/` ,icon:`line-md:instagram` }])
</script>
