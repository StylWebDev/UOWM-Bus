    ...
    >
      ...
      >
        ...
        <router-link :to="section.to"
                     class="max-md:px-1 max-md:py-1  px-4 py-1 md:text-lg  rounded-md text-center hover:bg-white hover:text-black bg-blue-500 transition-all duration-500 ease">
